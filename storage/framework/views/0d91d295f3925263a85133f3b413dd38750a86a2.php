...
<div class="row dashboardtext" style="padding-bottom:50px;padding-top:10px;">
    ...
    <div id="mainsearchdiv">
        <div class="listdiv2" style="padding-top:20px;margin-top:0 !important;padding-left:0 !important;padding-right:0 !important;border-radius:10px 10px;">
            <?php echo e(Form::open(array('url'=>'loans','method'=>'post','enctype'=>'multipart/form-data'))); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/banqgego/public_html/nobs/resources/views/loans/create.blade.php ENDPATH**/ ?>