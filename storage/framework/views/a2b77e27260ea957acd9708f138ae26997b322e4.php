...
<div class="tab-content">
  <div id="today"  class="tab-pane active">
    ...
    <table id="tdetailstable" class=" table-striped tableFixHead table-bordered" style="padding-bottom:0;position:relative;">
        ...
        <tbody>
            <?php $__currentLoopData = $todaytotalRF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transactions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  ...
  <div id="thisweek" class="tab-pane fade">
    ...
    <table id="tdetailstable" class=" table-striped tableFixHead table-bordered" style="padding-bottom:0;position:relative;">
        ...
        <tbody>
            <?php $__currentLoopData = $thisweektotalRF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transactions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                 <td title="<?php echo e(\Auth::user()->dateFormat($transactions->created_at)); ?>"><?php echo e($transactions->created_at); ?></td>
                 <td><strong class="text-success">GH¢ <?php echo e($transactions->amount); ?></strong></td> 
                 <td><?php echo e($transactions->det_rep_name_of_transaction); ?></td> 
 ...
 <strong  style="text-transform: capitalize;padding-left:10px;"> <?php echo e($nameoftransaction); ?> this month (<span style="color:#800860">GH¢ <?php echo e(number_format($thismonthtotal, 3, '.', ',')); ?></span>).</strong>
     ...
     <table id="tdetailstable" class=" table-striped tableFixHead table-bordered" style="padding-bottom:0;position:relative;">
        ...
        <tbody>
            <?php $__currentLoopData = $thismonthtotalRF; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transactions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/banqgego/public_html/nobsbackend/resources/views/reports/reportrf.blade.php ENDPATH**/ ?>