            ...
            <div style="display:none;" id="tab2">
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        ','data-toggle'=>'select','onChange' => 'getselectedloantext(this)','id' => 'loantypedraft'))); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/banqgego/public_html/nobs/resources/views/loanrequestdetail/create.blade.php ENDPATH**/ ?>