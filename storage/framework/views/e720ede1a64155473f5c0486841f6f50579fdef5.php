...
<div id="mainsearchdiv">
    <h4 class="card-title" style="margin-top:20px;">
      ...
      <button id="accountbtnpanel_<?php echo e($account->id); ?>" onclick="dataapi('<?php echo e($account->id); ?>',this);"  class="accordion card listdiv" style="background:#fff;width:99%;padding-left:0;padding-right:0;margin-left:0;margin-right:0;">
              ...
              <tr>
                  <td width="23%">
                      ...
                      <div> 
                          ...
                          <?php if($account->is_dataimage == 1): ?>
                          <img style="position:relative;float:left;margin-right:10px;" class="rounded-circle profilepic" src="<?php echo e($account->customer_customer_picture); ?>" is_dataimage="<?php echo e($account->is_dataimage); ?>" profilevalue="<?php echo e($account->customer_picture); ?>">
                          <?php endif; ?>
  
                          <?php if($account->is_dataimage == 0): ?>
                          <img style="position:relative;float:left;margin-right:10px;" class="rounded-circle profilepic" src="<?php echo e(env('NOBS_IMAGES')); ?>/profileimage.png" profilevalue="<?php echo e($account->customer_picture); ?>">
                          <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/nobsbackend/resources/views/accounts/index.blade.php ENDPATH**/ ?>