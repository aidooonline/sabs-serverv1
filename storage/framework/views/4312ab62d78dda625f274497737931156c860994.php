...
<input type="text" style="display:none" value="<?php echo e(\Auth::user()->created_by_user); ?>" name="user" />
                ...
                <div class="col-12">
                    <div class="form-group">
                        <label>Email</label>
                        <?php echo e(Form::text('email',null,array('class'=>'form-control','required'=>'required','readonly'=>'readonly'))); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/nobsbackend/resources/views/accounts/edit.blade.php ENDPATH**/ ?>