<style>
    ...
    <?php $__currentLoopData = $loanmigrations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loanrequest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <!-- TODAY -->
                      ...
                      <div  class="card-body">
                          <div class="card-block pt-1 pb-0 pl-0">
                             <ul style="border:0 !important;padding-left:15px;" class="list-group">
                                  ...
                                  <img src="" profilevalue="<?php echo e($loanrequest->customer_picture); ?>" class="profilepic" style="width:auto;max-width:70px;height:70px;position:absolute;top:10px;right:5px;z-index:2;border-radius:20px;" />
                                  <?php else: ?>
                                  <img src="<?php echo e(env('NOBS_IMAGES')); ?>/useraccounts/profileimage.png" style="width:auto;height:70px;max-width:70px;position:absolute;top:10px;right:5px;z-index:2;border-radius:20px;" />
                                  ...
                                  <li style="padding-top:0 !important;padding-bottom:0 !important;padding-left:10px;">
                                      <span class="row  mt-1"><strong class="font-medium-2 mb-0 pl-0 ml-0" style="color:#1a84b6">
                                              <?php echo e(number_format($loanrequest->approved_amount, 2, '.', ',')); ?></strong></span>
                                  </li>
                                 <li style="padding-top:0 !important;padding-bottom:0 !important" class="list-group-item"> 
                                      <span class="row mt-1"><span style="padding-left:10px;" class="textcolor1">
                                          <?php echo e($loanrequest->first_name); ?> <?php echo e($loanrequest->surname); ?> 
                                  ...
                                  <li style="padding-top:0 !important;padding-bottom:0 !important" class="list-group-item">
                                      <span class="row mt-1"><span style="padding-left:10px;font-weight:bold;color:#0e72a0" class="textcolor1">
                                          <?php echo e($loanrequest->loanname); ?>,<span 
                                          style="font-weight:normal !important;padding-left:5px;">To be paid in 
                                          <?php echo e(number_format($loanrequest->payment_duration, 0, '.', ',')); ?> days
                                      </span></span></span>
                                  </li>
                                  <li style="padding-top:0 !important;padding-bottom:0 !important;padding-right:0;padding-left:0 !important;" class="list-group-item">
                                    ...
                                    <a style="float:right;" onclick="addto_disbursement_form('<?php echo e($loanrequest->first_name); ?> <?php echo e($loanrequest->surname); ?>',<?php echo e($loanrequest->amount); ?>,'<?php echo e($loanrequest->loan_account_number); ?>',<?php echo e($loanrequest->id); ?>,'<?php echo e($loanrequest->customer_account_number); ?>','<?php echo e($loanrequest->loanname); ?>','<?php echo e($loanrequest->__id__); ?>','<?php echo e($loanrequest->phone_number); ?>','<?php echo e($loanrequest->phone); ?>','<?php echo e($loanrequest->agentname); ?>');" href="#"
   ...
   <nav style="margin-left:13px;margin-right:13px;padding-bottom:10px;padding-left:5px;padding-right:5px;padding-top:0 !important;" aria-label="Page navigation" class="card">
              <?php echo e($loanmigrations->links()); ?>
                       ...
                       <div class="col-12">
                        ...
                        <div class="col-12">
                           ...
                           <div class="col-12">
                            ...
                            <div class="form-group">
                                <?php echo e(Form::submit(__('Continue Disbursement'),array('class'=>'btn btn-sm btn-purple rounded-pill
...
function disburse_loan(name,ac_type,parent_id,actual_value,description,debitorcredit_id,dr_name,dr_account,cr_account,theamount,cr_name,disbursedid,acnumber,account_type,__id__,primary_account_number,isdisbursement,customer_phone,agent_phone,msg,agentname){
   ...
   $.ajaxSetup({
    ...
    $.ajax({
            url: "<?php echo e(route('ledger.storesub')); ?>",
...
function make_auto_depositjvs(customer_number,msg,account_number,account_type,amount,agentname,primary_account_number,agentmsge,agentnumber){
  ...
  showhidediv('loadingdiv');
      $.ajax({
          url: "<?php echo e(env('NOBS_IMAGES')); ?>disburse.php",
          method: "POST",      // The HTTP method to use for the request
          dataType: "html",   // The type of data that you're exerciseecting back 	
          data: {  
              __id__:__id__,
  ...
  <style>
    ...
    </script><?php /**PATH /home/banqgego/public_html/nobs001/resources/views/loanmigration/savingspartial_alltotal.blade.php ENDPATH**/ ?>