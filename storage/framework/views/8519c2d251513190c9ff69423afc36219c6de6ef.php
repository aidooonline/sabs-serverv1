...
<a href="#" data-size="lg" data-url="<?php echo e(route('loanrequests.create')); ?>" data-ajax-popup="true"
    data-title="<?php echo e(__('New Loan Request')); ?>" class="btn btn-sm btn-purple btn-icon-only rounded-circle">
...
<div id="mainsearchdiv">
    ...
    <?php echo $__env->make('loanrequestdetail.savingspartial_alltotal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>
</div>
<style>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/banqgego/public_html/nobs/resources/views/loanrequestdetail/index.blade.php ENDPATH**/ ?>