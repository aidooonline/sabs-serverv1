<?php echo e(Form::open(array('url'=>'call','method'=>'post','enctype'=>'multipart/form-data'))); ?>
...
<div class="row">
    ...
    <div class="col-6">
        <div class="form-group">
            <?php echo e(Form::label('direction',__('Direction'))); ?>

            <?php echo Form::select('direction', $direction, null,array('class' => 'form-control ','data-toggle'=>'select','required'=>'required')); ?>
...
<?php /**PATH /Applications/MAMP/htdocs/efloq/resources/views/call/create.blade.php ENDPATH**/ ?>