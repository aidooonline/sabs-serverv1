...
function insertloancustomer(accountid,accountnumber,customerpicture,firstname,lastname,phonenumber){
    //insertloancustomer('`+ accountid + `','`+ accountnumber + `','`+ customerpicture + `','`+ firstname + `','`+ lastname + `','`+ phonenumber + `')" id="accountbtnpanel_` + accountid +`
...
<?php /**PATH /home/banqgego/public_html/nobs/resources/views/layouts/searchloancustomer.blade.php ENDPATH**/ ?>