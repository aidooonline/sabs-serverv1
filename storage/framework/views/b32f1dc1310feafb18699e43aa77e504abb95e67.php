                    ...
                    <nav>
                        ...
                        <div style="display: inline-block;">
                            ...
                            <?php if(!empty(\Auth::user()->avatar)): ?>
                                <div class="avatar av-s header-avatar" style="margin: 0px 10px; margin-top: -5px; margin-bottom: -5px;background-image: url('<?php echo e(asset('/storage/upload/profile/'.\Auth::user()->avatar)); ?>');"></div>
                            <?php else: ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/efloq/resources/views/messenger/app.blade.php ENDPATH**/ ?>