<div id="nav" class="nav-container d-flex">
    <div class="nav-content d-flex">
        <div class="logo position-relative">
            <a href="Dashboards.Default.html" style="margin-left:20px;color:#fff !important;font-size:30px;font-weight:bolder;font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;padding-bottom:0 !important;">
                <!--<img src="http://localhost:8888/efloq3/public/img/logo/logo.svg"" alt="efloQ" style="min-height:10px;height: 15px;width: auto;margin-left: 20px;margin-bottom:10px" />--><span>eflo</span><span style="color:#f2c657">Q<span>
            </span></span></a>
        </div>
        <div class="language-switch-container" style="display:none !important;">
        ...
        <div class="user-container d-flex">
            <a href="#" class="d-flex user position-relative" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="profile" alt="profile" src="">
                <div class="name">Stephen Aidoo</div>
            </a>
            <div class="dropdown-menu dropdown-menu-end user-menu wide">
                <div class="row mb-3 ms-0 me-0">
                    <div class="col-10 ps-1 mb-2">
                    ...
                    <div class="col-10 ps-1 pe-1">
                        <ul class="list-unstyled">
                            <li>
                                ...
                                <a href="http://localhost:8888/efloq3/public/company/1/userprofile">User Profile</a>
                            </li>
                            <li>
                                
                                <a href="http://localhost:8888/efloq3/public/company/1/companyinfo">Company Profile</a>
                            </li>
                            <li>
                                <a href="#">
                ...
                <div style="display:none;" class="row mb-1 ms-0 me-0">
        ...
        <ul style="display:none !important;" class="list-unstyled list-inline text-center menu-icons">
                ...
                <div class="dropdown-menu dropdown-menu-end wide notification-dropdown scroll-out" id="notifications">
                    <div class="scroll os-host os-theme-dark os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-scrollbar-vertical-hidden os-host-transition"><div class="os-resize-observer-host observed"><div class="os-resize-observer" style="left: 0px; right: auto;"></div></div><div class="os-size-auto-observer observed" style="height: calc(100% + 1px); float: left;"><div class="os-resize-observer"></div></div><div class="os-content-glue" style="margin: 0px -15px; width: 29px;"></div><div class="os-padding"><div class="os-viewport os-viewport-native-scrollbars-invisible os-viewport-native-scrollbars-overlaid"><div class="os-content" style="padding: 0px 15px; height: 100%; width: 100%;">
                        <ul class="list-unstyled border-last-none">
                            ...
                            <li class="mb-3 pb-3 border- border-separator-light d-flex">
        ...
        <ul id="menu" class="menu show">
                <li class="dropdown">
                    <a href="#" data-href="Dashboards.html" class="dropdown-toggle" data-bs-toggle="dropdown">
                    ...
                    <ul id="dashboards" class="dropdown-menu opacityIn">
                        <li>
                            <a href="http://localhost:8888/efloq3/public/company/1/dashboard">
                                <span class="label">Dashboard Default</span>
                            </a>
                        </li>
                        <li>
                            <a href="http://localhost:8888/efloq3/public/company/1/dashboard/projects-properties">
                                <span class="label">Projects &amp; Properties</span>
                            </a>
                        </li>
                        <li>
                            <a href="http://localhost:8888/efloq3/public/company/1/dashboard/marketing">
                                <span class="label">Marketing</span>
                            </a>
                        </li>
                        <li>
                            <a href="http://localhost:8888/efloq3/public/company/1/dashboard/sales">
                                <span class="label">Sales</span>
                            </a>
                        </li>

                        <li>
                            <a href="http://localhost:8888/efloq3/public/company/1/dashboard/finance">
                                <span class="label">Finance</span>
                            </a>
                        </li>
                        <li>
                            <a href="http://localhost:8888/efloq3/public/company/1/dashboard/customer-service">
                ...
                <li class="dropdown">
                    ...
                    <ul id="projects-properties" class="dropdown-menu opacityIn">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle">
                                <span class="label">Projects</span>
                            </a>
                        
                            <ul id="projects-nav" class="dropdown-menu opacityIn">
                                
                                <li>
                                    <a href="http://localhost:8888/efloq3/public/company/1/projects/projectlist">
                                        <span class="label">Project List</span>
                                    </a>
                                </li> 

                                <li>
                                    <a href="http://localhost:8888/efloq3/public/company/1/projects/addnew">
                                        <span class="label">Add New Project</span>
                                    </a>
                                </li> 
                            </ul>
                        </li> 
                        <li>
                            <a href="http://localhost:8888/efloq3/public/company/1/projects//propertylist">
                ...
                <li class="dropdown">
                    ...
                    <a href="#" data-href="#" class="dropdown-toggle" data-bs-toggle="dropdown">
                        <i class="bi bi-megaphone"></i>
                        <span class="label">Marketing</span>
                    </a>
                    <ul id="marketing" style="display:none;" class="dropdown-menu opacityIn">
                        <li class="dropdown">
                            <a href="#" data-href="Pages.Authentication.html" class="dropdown-toggle">
                                <span class="label">Authentication</span>
                            </a>
                            <ul id="authentication" class="dropdown-menu opacityIn">
                                <li>
                        ...
                        <li class="dropdown">
                            <a href="#" data-href="Pages.Blog.html" class="dropdown-toggle">
                                <span class="label">Blog</span>
                            </a>
                            <ul id="blog" class="dropdown-menu opacityIn">
                                <li>
                        ...
                        <li class="dropdown">
                            <a href="#" data-href="Pages.Miscellaneous.html" class="dropdown-toggle">
                                <span class="label">Miscellaneous</span>
                            </a>
                            <ul id="miscellaneous" class="dropdown-menu opacityIn">
                                <li>
                        ...
                        <li class="dropdown">
                            <a href="#" data-href="Pages.Portfolio.html" class="dropdown-toggle">
                                <span class="label">Portfolio</span>
                            </a>
                            <ul id="portfolio" class="dropdown-menu opacityIn">
                                <li>
                        ...
                        <li class="dropdown">
                            <a href="#" data-href="Pages.Profile.html" class="dropdown-toggle">
                                <span class="label">Profile</span>
                            </a>
                            <ul id="profile" class="dropdown-menu opacityIn">
                                <li>
                ...
                <li class="dropdown">
                    ...
                    <ul id="sales" style="display:none;" class="dropdown-menu opacityIn">
                        <li>
                ...
                <li class="dropdown">
                    ...
                    <ul id="finance" style="display:none;" class="dropdown-menu opacityIn">
                ...
                <li class="dropdown">
                    ...
                    <ul id="customer-service" style="display:none;" class="dropdown-menu opacityIn">
                ...
                <li style="display:none;" class="mega dropdown">
                    <a href="#" data-href="Interface.html" class="dropdown-toggle" data-bs-toggle="dropdown">
                        <i data-cs-icon="pocket-knife" class="icon" data-cs-size="18"></i>
                        <span class="label">Interface</span>
                    </a>
                    <ul id="interface" class="row align-items-start row-cols-4 dropdown-menu opacityIn">
                        <li class="dropdown col d-flex flex-column">
                            <a href="#interfaceComponents" data-href="Interface.Components.html" class="dropdown-toggle">
                        ...
                        <li class="dropdown col d-flex flex-column">
                            <a href="#interfaceForms" data-href="Interface.Forms.html" class="dropdown-toggle">
                            ...
                            <ul id="interfaceForms">
                                ...
                                <li class="dropdown col d-flex flex-column">
                                    <a href="#formControls" data-href="Interface.Forms.Controls.html" class="dropdown-toggle">
                        ...
                        <li class="dropdown col d-flex flex-column">
                            <a href="#interfacePlugins" data-href="Interface.Plugins.html" class="dropdown-toggle">
                            ...
                            <ul id="interfacePlugins">
                                ...
                                <li class="dropdown col d-flex flex-column">
                                    <a href="#pluginsDatatables" data-href="Interface.Plugins.Datatables.html" class="dropdown-toggle">
                        ...
                        <li class="dropdown col d-flex flex-column">
                            <a href="#interfaceContent" data-href="Interface.Content.html" class="dropdown-toggle">
                                <span class="label">Content</span>
                            </a>
                            <ul id="interfaceContent">
                                <li class="dropdown col d-flex flex-column">
                                    <a href="#icons" data-href="Interface.Content.Icons.html" class="dropdown-toggle">
                                ...
                                <li class="dropdown col d-flex flex-column">
                                    <a href="#menuVarieties" data-href="Interface.Content.Menu.html" class="dropdown-toggle">
                                    ...
                                    <ul id="menuVarieties">
                                        ...
                                        <li class="col d-flex flex-column"></li>
                                        <li class="col d-flex flex-column">
...
</div><?php /**PATH /Applications/MAMP/htdocs/efloq/resources/views/partials/admin/topmenu.blade.php ENDPATH**/ ?>