...
<?php $__env->startSection('action-btn'); ?>
    <a href="<?php echo e(route('meeting.index')); ?>" class="btn btn-sm btn-primary bor-radius ml-4">
                ...
                <div class="card hover-shadow-lg">
                    <div class="card-body text-center">
                        <div class="avatar-parent-child">
                            <img alt="" class="rounded-circle avatar" <?php if(!empty($meeting->avatar)): ?> src="<?php echo e((!empty($meeting->avatar))? asset(Storage::url("upload/profile/".$meeting->avatar)): asset(url("./assets/img/clients/160x160/img-1.png"))); ?>" <?php else: ?>  avatar="<?php echo e($meeting->name); ?>" <?php endif; ?>>
                        </div>
                        ...
                        <?php if(Gate::check('Show Meeting') || Gate::check('Edit Meeting') || Gate::check('Delete Meeting')): ?>
                            ...
                            <div class="actions d-flex justify-content-between px-4">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Show Meeting')): ?>
                                    <a href="#" data-size="lg" data-url="<?php echo e(route('meeting.show',$meeting->id)); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Create New Meeting')); ?>" class="action-item">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/efloq/resources/views/meeting/grid.blade.php ENDPATH**/ ?>