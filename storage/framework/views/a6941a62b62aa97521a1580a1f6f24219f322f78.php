                            ...
                            <div data-v-f2a183a6="" class="d-header" style="background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?>">
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        <div data-v-f2a183a6="" class="d-title"><?php echo e(__('SALES ORDER')); ?></div>
                                        <table data-v-f2a183a6="" class="summary-table">
                                            <tbody data-v-f2a183a6="">
                                            <tr>
                                                <td><?php echo e(__('Number')); ?>:</td>
                                                <td><?php echo e(\App\Utility::salesorderNumberFormat($settings,$salesorder->salesorder)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('Issue Date')); ?>:</td>
                                                <td><?php echo e(\App\Utility::dateFormat($settings,$salesorder->issue_date)); ?></td>
                                            </tr>
                                            </tbody>
                                    ...
                                    <div class="row">
                                        <div class="bill_to">
                                            ...
                                            <p>
                                                ...
                                                <?php echo e(!empty($user->bill_city)?$user->bill_city:'' . ', '); ?> <?php echo e(!empty($user->bill_state)?$user->bill_state:''); ?>,<?php echo e(!empty($user->bill_country)?$user->bill_country:''); ?>
                                    ...
                                    <div data-v-363339a0="" class="d-table">
                                        <div data-v-363339a0="" class="d-table">
                                            ...
                                            <div class="d-table-tr" style="border-bottom:1px solid <?php echo e($color); ?>;">
                                                ...
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6=""><?php echo e($salesorder->totalQuantity); ?></pre>
                                                </div>
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6=""><?php echo e(\App\Utility::priceFormat($settings,$salesorder->totalRate)); ?></pre>
                                                </div>
                                                <div class="d-table-td w-6">
                                                    <pre data-v-f2a183a6=""><?php echo e(\App\Utility::priceFormat($settings,$salesorder->totalTaxPrice)); ?></pre>
                                                </div>
                                                <?php if($salesorder->discount_apply==1): ?>
                                                    <div class="d-table-td w-3">
                                                        <pre data-v-f2a183a6=""><?php echo e(\App\Utility::priceFormat($settings,$salesorder->totalDiscount)); ?></pre>
                                                    </div>
                                                <?php else: ?>
                                                    <div class="d-table-td w-3">
                                                        <pre data-v-f2a183a6="">-</pre>
                                                ...
                                                <div class="d-table-td w-4 text-right">
                                                    <span><?php echo e(\App\Utility::priceFormat($settings,$salesorder->getSubTotal())); ?>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    <?php if($salesorder->discount_apply==1): ?>
                                                        <?php if($salesorder->getTotalDiscount()): ?>
                                                            <div data-v-f2a183a6="" class="d-table-summary-item">
                                                                ...
                                                                <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Utility::priceFormat($settings,$salesorder->getTotalDiscount())); ?></div>
                                                            </div>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid <?php echo e($color); ?>; border-bottom: 1px solid <?php echo e($color); ?>;">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Utility::priceFormat($settings,$salesorder->getSubTotal()-$salesorder->getTotalDiscount()+$salesorder->getTotalTax())); ?></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<?php /**PATH /home/banqgego/public_html/nobsbackend/resources/views/salesorder/templates/template1.blade.php ENDPATH**/ ?>