        ...
        <tr data-action="0">
            ...
            <td style="position: relative">
                ...
                <?php if(!empty($user->avatar)): ?>
                    <div class="avatar av-m" style="background-image: url('<?php echo e(asset('/storage/'.config('chatify.user_avatar.folder').'/'.$user->avatar)); ?>');">
                    </div>
                <?php else: ?>
                    <img class="avatar av-m" avatar="<?php echo e($user->name); ?>">
                <?php endif; ?>
            </td>
...
<?php /**PATH /Applications/MAMP/htdocs/efloq/resources/views/messenger/layouts/listItem.blade.php ENDPATH**/ ?>