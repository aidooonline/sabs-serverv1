    ...
    <?php echo $__env->make('layouts.search', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      ...
      <div id="mainsearchdiv">
        ...
        <h4 class="card-title" style="margin-top:20px;margin-left:30px;">
            Loan Payment from : <span class="text-warning"> <?php echo e($useraccount1->first_name); ?> <?php echo e($useraccount1->middle_name); ?> <?php echo e($useraccount1->surname); ?></span>
          </h4>
...
<?php endif; ?>
        ...
        <div class="col-11 insetshadow">
            ...
            <div class="form-group">
                ...
                <input class="btn btn-purple mb-2 customercodebtn" id="confirmcustomercode" type="button" onclick="makedepositjvs('<?php echo e($useraccount2->phone_number); ?>','Deposit of GHs ' + $('#amount').val() + ' credited to your account.')" value="Deposit" />
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/banqgego/public_html/nobsbackend/resources/views/accounts/loan_repayment/create.blade.php ENDPATH**/ ?>