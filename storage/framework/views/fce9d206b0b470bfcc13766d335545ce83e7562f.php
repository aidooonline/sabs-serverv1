...
<div class="row dashboardtext" style="padding-bottom:50px;padding-top:10px;">
    ...
    <div id="mainsearchdiv">
        ...
        <div class="listdiv2"
            ...
            <?php echo e(Form::model($loanrequestdetail,array('route' => array('loanrequestdetail.update', $loanrequestdetail->id),
            'method' => 'PUT'))); ?>
...
<div id="tab1">
    ...
    <div class="col-12">
        <div class="form-group">
            ...
            <?php echo e(Form::text('first_name',null,array('class'=>'form-control','id'=>"first_name",'required'=>'required','readonly'=>'readonly'))); ?>
    ...
    <div class="col-12">
        <div class="form-group">
            ...
            <?php echo e(Form::text('last_name',null,array('class'=>'form-control','id'=>"last_name",'required'=>'required','readonly'=>'readonly'))); ?>
    ...
    <div class="col-12">
        <div class="form-group">
            ...
            <?php echo e(Form::text('phone_number',null,array('class'=>'form-control','id'=>"phone_number",'required'=>'required','readonly'=>'readonly'))); ?>
    ...
    <div class="col-12">
        <div class="form-group">
            ...
            <?php echo e(Form::text('account_number',null,array('class'=>'form-control','id'=>"account_number",'required'=>'required','readonly'=>'readonly'))); ?>
    ...
    <div class="col-12">
        <div class="form-group">
            ...
            <?php echo e(Form::text('customer_account_id',null,array('class'=>'form-control','id'=>"customer_account_id",'required'=>'required','readonly'=>'readonly'))); ?>

          
            <?php echo e(Form::text('loan_account_number',null,array('class'=>'form-control','id'=>"loan_account_number",'required'=>'required','readonly'=>'readonly'))); ?>
...
<div style="display:none;" id="tab2">
    ...
    <input type="hidden" name="id" value="<?php echo e($loanrequestdetail->id); ?>" />

    <input type="hidden" name="loan_migrated" value="<?php echo e($loanrequestdetail->loan_migrated); ?>" />

    <div style="display:none" class="col-12">
        <div class="form-group">
            <label>Loan Type</label>
            <?php echo e(Form::text('loan_name',null,array('class'=>'form-control','required'=>'required','id' => 'loannameid'))); ?>

            <?php echo e(Form::text('loan_id',null,array('class'=>'form-control','required'=>'required','id' => 'loanid'))); ?>

            <?php echo e(Form::text('loan_purpose',null,array('class'=>'form-control','required'=>'required','id' => 'loanpurposeid'))); ?>
    ...
    <div class="col-12">
        <div class="form-group">
            ...
            <?php echo e(Form::select('loan_purposes', $loanpurpose, null,array('class' => 'form-control
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/banqgego/public_html/nobs/resources/views/loanrequestdetail/edit.blade.php ENDPATH**/ ?>