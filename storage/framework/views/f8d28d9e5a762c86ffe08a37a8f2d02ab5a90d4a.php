      ...
      <div class="card-block pt-2 pb-0">
        <div class="media">
          ...
          <div class="media-body white text-left">
            ...
            <span class="tag badge badge-pill bgpurple mt-1">Interest: <span class="textcolor1"><?php echo e($loans->interest); ?></span></span> 
            <span class="tag badge badge-pill bgpurple mt-1">Duration: <span class="textcolor1"><?php echo e($loans->duration); ?></span></span> 
            <span class="tag badge badge-pill bgpurple mt-1">Interest Per Anum: <span class="textcolor1"><?php echo e($loans->interest_per_anum); ?></span></span> 
...
<?php /**PATH /home/banqgego/public_html/nobs/resources/views/loans/savingspartial_alltotal.blade.php ENDPATH**/ ?>