    ...
    <table style="background-color:#f4e9f7 !important;margin-top:0;"  class="table-striped table-border table-panel">
        ...
        <tr>
            ...
            <tr>
                ...
                <td class="mintd" style="padding:1px 1px;" id="tdbalanceid_<?php echo e($savings->id); ?>"></td>
              </tr>
...
</div><?php /**PATH /home/banqgego/public_html/nobsbackend/resources/views/savings/savingspartial_singletotal.blade.php ENDPATH**/ ?>