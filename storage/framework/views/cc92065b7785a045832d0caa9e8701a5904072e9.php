...
<div id="mainsearchdiv">
    ...
    <a href="<?php echo e(route('agents.transactiondetails')); ?>/<?php echo e($account->created_by_user); ?>/<?php echo e($account->name); ?>" id="accountbtnpanel_<?php echo e($account->id); ?>"  class="accordion card listdiv" style="background:#fff;width:99%;padding-left:0;padding-right:0;margin-left:0;margin-right:0;">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/nobsbackend/resources/views/agents/index.blade.php ENDPATH**/ ?>