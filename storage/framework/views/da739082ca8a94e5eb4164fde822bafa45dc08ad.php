                            ...
                            <div data-v-f2a183a6="" class="d-header" style="background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?>">
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        <div data-v-f2a183a6="" class="d-title"><?php echo e(__('QUOTE')); ?></div>
                                        <table data-v-f2a183a6="" class="summary-table">
                                            <tbody data-v-f2a183a6="">
                                            <tr>
                                                <td><?php echo e(__('Number')); ?>:</td>
                                                <td><?php echo e(\App\Utility::quoteNumberFormat($settings,$quote->quote)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('Issue Date')); ?>:</td>
                                                <td><?php echo e(\App\Utility::dateFormat($settings,$quote->issue_date)); ?></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <div data-v-363339a0="" class="d-table">
                                        <div data-v-363339a0="" class="d-table">
                                            ...
                                            <div class="d-table-tr" style="border-bottom:1px solid <?php echo e($color); ?>;">
                                                ...
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6=""><?php echo e($quote->totalQuantity); ?></pre>
                                                </div>
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6=""><?php echo e(\App\Utility::priceFormat($settings,$quote->totalRate)); ?></pre>
                                                </div>
                                                <div class="d-table-td w-6">
                                                    <pre data-v-f2a183a6=""><?php echo e(\App\Utility::priceFormat($settings,$quote->totalTaxPrice)); ?></pre>
                                                </div>
                                                <?php if($quote->discount_apply==1): ?>
                                                    <div class="d-table-td w-3">
                                                        <pre data-v-f2a183a6=""><?php echo e(\App\Utility::priceFormat($settings,$quote->totalDiscount)); ?></pre>
                                                    </div>
                                                <?php else: ?>
                                                    <div class="d-table-td w-3">
                                                        <pre data-v-f2a183a6="">-</pre>
                                                ...
                                                <div class="d-table-td w-4 text-right">
                                                    <span><?php echo e(\App\Utility::priceFormat($settings,$quote->getSubTotal())); ?>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    <?php if($quote->discount_apply==1): ?>
                                                        <?php if($quote->getTotalDiscount()): ?>
                                                            <div data-v-f2a183a6="" class="d-table-summary-item">
                                                                ...
                                                                <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Utility::priceFormat($settings,$quote->getTotalDiscount())); ?></div>
                                                            </div>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid <?php echo e($color); ?>; border-bottom: 1px solid <?php echo e($color); ?>;">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Utility::priceFormat($settings,$quote->getSubTotal()-$quote->getTotalDiscount()+$quote->getTotalTax())); ?></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<?php /**PATH /home/banqgego/public_html/nobsbackend/resources/views/quote/templates/template1.blade.php ENDPATH**/ ?>