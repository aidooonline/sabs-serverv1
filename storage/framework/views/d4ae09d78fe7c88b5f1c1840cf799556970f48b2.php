...
<a style="display:none" href="#" data-size="lg" data-url="<?php echo e(route('accounts.create')); ?>" data-ajax-popup="true"
...
<input type="text" style="display:none" value="<?php echo e(\Auth::user()->created_by_user); ?>" name="user" />
	...
	<div id="camerascript" style="display:none;">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/banqgego/public_html/nobsback/resources/views/accounts/create.blade.php ENDPATH**/ ?>