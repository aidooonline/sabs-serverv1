...
<div class="w-100">
    ...
    <div class="col-sm-8 col-lg-5">
        <div class="row justify-content-center mb-3">
            <a  style="color:#ffffff;font-size:22px;" class="navbar-brand" href="#">
                efloQ
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/nobsbackend/resources/views/auth/register.blade.php ENDPATH**/ ?>