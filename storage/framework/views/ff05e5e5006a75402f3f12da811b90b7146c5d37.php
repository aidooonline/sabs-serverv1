...
<script type="text/javascript" src="<?php echo e(asset('assets/nobsdocs/vendors/js/perfect-scrollbar.jquery.min.js')); ?>"></script> 
  ...
  <script type="text/javascript" src="<?php echo e(asset('assets/nobsdocs/vendors/js/pace/pace.min.js')); ?>"></script>
   ...
   <!-- <script type="text/javascript" src="<?php echo e(asset('assets/nobsdocs/vendors/js/dropzone.min.js')); ?>"></script>-->
    <script type="text/javascript" src="<?php echo e(asset('assets/nobsdocs/vendors/js/prism.min.js')); ?>"></script>
    
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN CONVEX JS-->  
      <script type="text/javascript" src="<?php echo e(asset('assets/nobsdocs/js/dropzone.js')); ?>"></script>
...
<?php /**PATH /home/banqgego/public_html/nobsback/resources/views/partials/admin/footer.blade.php ENDPATH**/ ?>