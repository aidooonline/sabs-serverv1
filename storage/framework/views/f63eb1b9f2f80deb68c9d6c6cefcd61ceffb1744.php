...
<?php $__env->startSection('title'); ?>
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0 "><?php echo e(__('Invoice Analytic')); ?></h5>
    </div>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('Home')); ?></a></li>
    <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('Invoice Analytic')); ?></li>
<?php $__env->stopSection(); ?>
                ...
                <div class="cardcard-body">
                    <div class="collapse show float-right" id="collapseExample" style="">
                        ...
                        <div class="row filter-css">
                            ...
                            <div class="col-auto">
                                <?php echo e(Form::select('account',$account,isset($_GET['account'])?$_GET['account']:'', array('class' => 'form-control ','data-toggle'=>'select'))); ?>
                            ...
                            <div class="col-auto pt-2">
                                <a href="<?php echo e(route('report.invoiceanalytic')); ?>" data-toggle="tooltip" data-title="<?php echo e(__('Reset')); ?>" class="btn btn-xs btn-danger btn-icon-only rounded-circle"><i class="fas fa-trash-restore"></i></a>
                            </div>
                            <div class="col-auto pt-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($result->status == 0): ?>
                                    <span class="badge badge-info"><?php echo e(__(\App\Invoice::$status[$result->status])); ?></span>
                                <?php elseif($result->status == 1): ?>
                                    <span class="badge badge-info"><?php echo e(__(\App\Invoice::$status[$result->status])); ?></span>
                                <?php elseif($result->status == 2): ?>
                                    <span class="badge badge-info"><?php echo e(__(\App\Invoice::$status[$result->status])); ?></span>
                                <?php elseif($result->status == 3): ?>
                                    <span class="badge badge-success"><?php echo e(__(\App\Invoice::$status[$result->status])); ?></span>
                                <?php elseif($result->status == 4): ?>
                                    <span class="badge badge-warning"><?php echo e(__(\App\Invoice::$status[$result->status])); ?></span>
                                <?php elseif($result->status == 5): ?>
                                    <span class="badge badge-danger"><?php echo e(__(\App\Invoice::$status[$result->status])); ?></span>
                                <?php endif; ?>
                            </td>
                            <td class="">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/efloq/resources/views/report/invoiceanalytic.blade.php ENDPATH**/ ?>