    ...
    <div class="card-stats">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col">
                    <input id="search" class="search" type="search" placeholder=" &#x1F50D Search by Transaction ID" />
...
function showsearchrow(accountid,accountnumber,customerpicture,occupation,residentialaddress,accounttypes,firstname,surname,phonenumber){
   var result =`<button id="accountbtnpanel_` + accountid +`" onclick="movetorefundpage('` + accountnumber +`',this,` + phonenumber + `);" class="accordion card listdiv" style="background:#fff;width:99%;padding-left:0;padding-right:0;margin-left:0;margin-right:0;">
...
<table class="table table-panel">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="mintd"><a href="<?php echo e(route('accounts.transactiondetails')); ?>/` + accountnumber +`" >` + accountnumber +`</a></td>
        </tr>
...
<?php /**PATH /home/banqgego/public_html/nobsbackend/resources/views/layouts/searchrefund.blade.php ENDPATH**/ ?>