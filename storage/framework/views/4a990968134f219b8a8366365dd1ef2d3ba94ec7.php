    ...
    <div class="row">
        ...
        <div class="col-12" style="display:none;">
            <div class="form-group">
                ...
                <input   readonly id="created_by_user" name="created_by_user" class="form-control" type="text" value="" />
...
function setunique(){
    let uniqid = uuidv4();
$("#created_by_user").val('users/' + uniqid);
}
...
function uuidv4() {
  return ([1e7]+1e3+4e3+8e3+1e11).replace(/[018]/g, c =>
    ...
    </script><?php /**PATH /Applications/MAMP/htdocs/nobsbackend/resources/views/user/create.blade.php ENDPATH**/ ?>