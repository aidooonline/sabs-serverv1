...
function showsearchrow(accountid,accountnumber,customerpicture,occupation,residentialaddress,accounttypes,firstname,surname,phonenumber){
   var result =`<button id="accountbtnpanel_` + accountid +`" onclick="movetodepositpage('` + accountnumber +`',this,` + phonenumber + `);" class="accordion card listdiv" style="background:#fff;width:99%;padding-left:0;padding-right:0;margin-left:0;margin-right:0;">
...
<?php /**PATH /home/banqgego/public_html/nobsbackend/resources/views/layouts/searchdeposit.blade.php ENDPATH**/ ?>