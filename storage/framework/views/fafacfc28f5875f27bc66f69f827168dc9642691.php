...
<div id="mainsearchdiv">
    <h4 class="card-title" style="margin-top:20px;">Customers Regsitered: <strong class="text-warning"><?php echo e($agentname); ?> </strong>
      </h4> 
        ...
        <table style="background-color:#f4e9f7 !important;margin-top:20px;"  class="table-striped table-border table-panel rounded">
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td class="mintd" style="padding:1px 1px;" id="todaytotal"><?php echo e($todaytotalCR); ?></td>
                  </tr>
      
                  <tr>
                    <td class="mintd" style="padding:1px 1px;">This Week:</td>
                    <td class="mintd" style="padding:1px 1px;" id="thisweektotal"><?php echo e($thisweektotalCR); ?></td>
                  </tr>
      
                  <tr>
                    <td class="mintd" style="padding:1px 1px;">This Month:</td>
                    <td class="mintd" style="padding:1px 1px;" id="thismonthtotal"><?php echo e($thismonthtotalCR); ?></td>
                  </tr>
      
                  <tr>
                    <td class="mintd" style="padding:1px 1px;">This Year:</td>
                    <td class="mintd" style="padding:1px 1px;" id="thismonthtotal"><?php echo e($thisyeartotalCR); ?></td>
                  </tr>
...
<div style="width:97%;position:relative;height:auto;margin-left:2%;margin-right:1% !important;">
    <table id="tdetailstable" class="table-striped tableFixHead table-bordered" style="padding-bottom:0;position:relative;">
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo e($account->first_name); ?> <?php echo e($account->surname); ?></td>
                <td><strong><?php echo e($account->account_number); ?></strong></td>
                <td><?php echo e($account->phone_number); ?></td>
                <td><?php echo e($account->occupation); ?></td>
            </tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/banqgego/public_html/nobsbackend/resources/views/dashboard/agent_customersregistered.blade.php ENDPATH**/ ?>