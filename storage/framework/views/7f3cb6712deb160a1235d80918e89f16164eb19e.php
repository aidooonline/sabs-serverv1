...
<div class="row dashboardtext">
                    ...
                    <div class="col-auto">
                        <div class="icon bg-gradient-secondary text-white rounded-circle icon-shape">
                            ...
                            <a href="<?php echo e(route('logout')); ?>"
                                ...
                                style="height:30px;font-size:12px;padding: 2px 2px;float:right;">
    ...
    <div class="row card-stats">
        ...
        <div class="card-body pb-20">
            ...
            <?php if(\Auth::user()->type=='Admin' || \Auth::user()->type=='owner'): ?>
            <a href="<?php echo e(route('loanrequests.requests')); ?>" onclick="showhidediv('loadingdiv');" class="col card icondiv"
                style="float:left;">
                <i class="fas fa-arrow-down text-purple"></i>
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/banqgego/public_html/nobs/resources/views/home.blade.php ENDPATH**/ ?>