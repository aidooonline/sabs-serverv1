...
<?php echo $__env->make('savings.savingspartial_alltotal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <?php $__currentLoopData = $savingsaccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $savings): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

    <button id="accountbtnpanel_<?php echo e($savings->id); ?>" onclick="dataapi('<?php echo e($savings->id); ?>',this);" class="accordion card listdiv" style="height:60px;background:#fff;width:99%;padding-left:20px;padding-right:20px;margin-left:0;margin-right:0;">
                ...
                <td  style="text-align:left; ">
                    <div style="text-align:left;padding-top:1px !important;">
                        <h6 class="account_name" style="padding-top:1px !important;">
                            <?php echo e($savings->account_name); ?></h6>
...
<?php echo $__env->make('savings.savingspartial_singletotal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/banqgego/public_html/nobsbackend/resources/views/savings/index.blade.php ENDPATH**/ ?>