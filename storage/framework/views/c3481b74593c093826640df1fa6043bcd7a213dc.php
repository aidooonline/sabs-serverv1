...
<head>
    ...
    <title><?php echo e(__('SalesGo SaaS')); ?></title>
            ...
            <div class="row top-bar">
                <div class="col-lg-6 col-md-6 left-part">
                    <ul>
                        <li>
                            <a href="#">
                                <img src="<?php echo e(asset(Storage::url('uploads/logo/')).'/logo.png'); ?>" height="33px" width="130px" alt="logo">
                            </a>
                        </li>
                        <li>
                    ...
                    <div id="Settings" class="tab-pane fade">
                        <div class="row">
                            <div class="col-lg-4 col-sm-6 col-md-6">
                                <div class="panal-1">
                                    <figure>
                                        <img alt="data-1" src="<?php echo e(asset('landing/images/tab-8.png')); ?>">
                                        <figcaption>
                                            <div class="contant-tab">
                                                <h5>Dashboard</h5>
                                                <p>Main Page</p>
                            ...
                            <div class="col-lg-4 col-sm-6 col-md-6">
                                <div class="panal-1">
                                    <figure>
                                        <img alt="data-1" src="<?php echo e(asset('landing/images/tab-9.png')); ?>">
                                        <figcaption>
                                            <div class="contant-tab">
                                                <h5>Dashboard</h5>
                                                <p>Main Page</p>
                            ...
                            <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-lg-3 col-ms-6 col-sm-6 mb-4">
                                    <div class="plan-2">
                                        ...
                                        <p class="price">
                                            <sup><?php echo e(!empty(env('CURRENCY_SYMBOL'))?env('CURRENCY_SYMBOL'):'$'); ?></sup>
                                            <?php echo e($plan->price); ?>

                                            <sub> <?php echo e($plan->duration); ?></sub>
                                        </p>
                                        <p class="price-text"><?php echo e($plan->description); ?></p>
                                        <ul class="plan-detail">
                                            <li><?php echo e($plan->max_user); ?> User</li>
                                            <li><?php echo e($plan->max_account); ?> Account</li>
                                            <li><?php echo e($plan->max_contact); ?> Contact</li>
                                        </ul>
                                        <a href="<?php echo e(route('register')); ?>" class="button">Active Free Trial</a>
                                    </div>
                                </div>
                            ...
                            <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-lg-3 col-ms-6 col-sm-6 mb-4">
                                    <div class="plan-2">
                                        ...
                                        <ul class="plan-detail">
                                            <li><?php echo e($plan->max_employee); ?> Employee</li>
                                            <li><?php echo e($plan->max_client); ?> Client</li>
                                        </ul>
...
<?php /**PATH /Applications/MAMP/htdocs/efloq/resources/views/layouts/landing.blade.php ENDPATH**/ ?>