...
<?php echo $__env->make('layouts.inlinecss', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 ...
 <div class="card-body pb-20">
   ...
   <?php if(\Auth::user()->type=='Admin' || \Auth::user()->type=='owner' || \Auth::user()->type=='Agents'|| \Auth::user()->type=='Teller'): ?>
    <a href="<?php echo e(env('BASE_URL')); ?>accounts/create" class="col card icondiv"  style="float:left;">
    ...
    <a style="display:none" href="#" onclick="getbuttons('Savings***<?php echo e(env('BASE_URL')); ?>savings/___Loans***<?php echo e(env('BASE_URL')); ?>loans/')" class="col card icondiv" data-toggle="modal" data-target="#exampleModal4"  class="col card icondiv" style="float:left;">
        
        <i class="fas fa-file-invoice-dollar text-purple"></i>
        <span class="mb-0 "><?php echo e(__('System Accounts')); ?></span>
    </a> 
     <?php if(\Auth::user()->type=='Admin' || \Auth::user()->type=='owner'): ?>
     <a href="<?php echo e(env('BASE_URL')); ?>savings/"  class="col card icondiv"  class="col card icondiv" style="float:left;">
 ...
 <a href="<?php echo e(env('BASE_URL')); ?>loans/"  class="col card icondiv"  class="col card icondiv" style="float:left;display:none;">
    ...
    <a href="<?php echo e(route('withdrawrequests.lists')); ?>"  class="col card icondiv" style="float:left;">
           <i class="fas fa-arrow-down text-purple"></i>
    ...
    <?php endif; ?>
     ...
     <?php if(\Auth::user()->type=='Admin' || \Auth::user()->type=='owner'): ?>
    <a href="<?php echo e(route('accounts.searchloan')); ?>/<?php echo e(Auth::user()->created_by_user); ?>"  class="col card icondiv" style="float:left;">
        <i class="fas fa-arrow-up text-purple"></i>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/banqgego/public_html/nobsbackend/resources/views/home.blade.php ENDPATH**/ ?>