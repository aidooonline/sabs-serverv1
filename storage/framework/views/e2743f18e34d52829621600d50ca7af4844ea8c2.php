...
<h4 class="card-title" style="margin-top:20px;">
    ...
    <div class="listdiv"
        ...
        <table class="table" style="vertical-align: center;text-align:center;width:95%;">
            <?php $__currentLoopData = $account; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $useraccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
             <td><a href="tel:<?php echo e($useraccount->phone_number); ?>" class="btn btn-xs btn-secondary  rounded"><i class="fa fa-phone"></i> Call </a></td>
             <td><a href="mailto:<?php echo e($useraccount->email); ?>" class="btn btn-xs  btn-secondary  rounded"><i class="fa fa-envelope"></i> Mail</a></td>
             <td><a href="sms://<?php echo e($useraccount->phone_number); ?>" class="btn btn-xs   btn-secondary rounded"><i class="fa fa-envelope-open-text"></i> Sms</a></td>
             <td><a href="https://wa.me/<?php echo e($useraccount->phone_number); ?>" class="btn btn-xs  btn-secondary  rounded"><i class="fa fa-whatsapp"></i> Whatsapp</a></td>
         </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/nobsbackend/resources/views/accounts_transactions/index.blade.php ENDPATH**/ ?>