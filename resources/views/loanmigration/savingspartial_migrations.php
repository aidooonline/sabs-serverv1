...
<img src="" profilevalue="{{$loanrequest->customer_picture}}" class="profilepic" style="width:70px;height:auto;position:absolute;top:10px;right:5px;z-index:2;border-radius:20px;" />
                       
@else
<img src="{{env('NOBS_IMAGES')}}/useraccounts/profileimage.png" style="width:70px;height:auto;position:absolute;top:10px;right:5px;z-index:2;border-radius:20px;" />
...
@endif    
                            ...
                            <div class="media-right text-left mr-2">
                                ...
                                <a style="position:absolute;right:2px !important;bottom:5px;" href="{{route('loanmigrations.migrate')}}/{{$loanrequest->id}}/{{$loanrequest->customer_account_id}}"
                                    class="btn btn-purple mr-1 btn-fab btn-sm">
                                    Migrate <i class="fa fa-angle-double-right"></i>
                                </a>

                                <input type="hidden" class='loan_request_rating' value="{{$loanrequest->loan_request_rating}}"/>       
                            </div>
                        </div>
