...
<table>
    <tr>
        <td width="23%">
            <div> <img style="position:relative;float:left;margin-right:10px;" class="rounded-circle" src="{{env('NOBS_IMAGES')}}images/user_avatar/avatar_` + accountid + `.jpg?lastmod=<?php echo date("m/d/Y h:i:s a", time())?>"></div>
        </td>
