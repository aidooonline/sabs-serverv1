...
<div class="row dashboardtext" style="padding-bottom:150px;padding-top:60px;">
    ...
    <div id="mainsearchdiv">
        ...
        <div class="listdiv2" style="padding-top:20px;margin-top:0 !important;padding-left:0 !important;padding-right:0 !important;border-radius:10px 10px;">
            ...
            {{Form::open(array('url'=>'ledgergeneral','method'=>'post','enctype'=>'multipart/form-data'))}}
            @csrf  
            ...
            <div>
                ...
                <div class="col-12">
                    <div class="form-group">
                        <label>Account Type</label>   {{-- <a style="position:absolute;right:20px;" href="{{route('ledgeraccounttypes.create')}}"  href="#"
                        class="btn btn-purple  mr-1 btn-fab btn-sm">
                        <i class="fa fa-plus"></i>
                        </a> --}}
                        {!! Form::select('ac_type', $ledgertype, null,array('class' => 'form-control','data-toggle'=>'select',)) !!} 
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        {!! Form::select('parent_id', $parentcategory, null,array('class' => 'form-control','data-toggle'=>'select')) !!}
                    </div>
                </div>
