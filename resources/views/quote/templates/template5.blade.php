                        ...
                        <div data-v-e23d9750="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-e23d9750="" class="d-inner">
                                <div data-v-e23d9750="" class="row">
                                    <div data-v-e23d9750="" class="col-66"><h1 data-v-e23d9750="" class="fancy-title tu mb5" style="background: {{$color}};color:{{$font_color}}">{{__('QUOTE')}}</h1></div>
                                    ...
                                    <div data-v-e23d9750="" class="col-33">
                                        <table data-v-e23d9750="" class="summary-table">
                                            ...
                                            <tr data-v-363339a0="">
                                                ...
                                                <td data-v-363339a0="" class="text-right">{{\App\Utility::invoiceNumberFormat($settings,$quote->quote)}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
                                                <td data-v-363339a0="" class="tu fwb" style="color: {{$color}};">{{__('Issue Date')}}:</td>
                                                <td data-v-363339a0="" class="text-right">{{\App\Utility::dateFormat($settings,$quote->date_quoted)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                ...
                                <div data-v-363339a0="" class="d-table">
                                    <div data-v-363339a0="" class="d-table">
                                        ...
                                        <div class="d-table-tr" style="border-bottom:1px solid {{$color}};">
                                            ...
                                            <div class="d-table-td w-3">
                                                <pre data-v-f2a183a6="">{{\App\Utility::priceFormat($settings,$quote->totalRate)}}</pre>
                                            </div>
                                            <div class="d-table-td w-6">
                                                <pre data-v-f2a183a6="">{{\App\Utility::priceFormat($settings,$quote->totalTaxPrice) }}</pre>
                                            </div>
                                            @if($quote->discount_apply==1)
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6="">{{\App\Utility::priceFormat($settings,$quote->totalDiscount)}}</pre>
                                                </div>
                                            @else
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6="">-</pre>
                                            ...
                                            <div class="d-table-td w-4 text-right">
                                                    <span>{{\App\Utility::priceFormat($settings,$quote->getSubTotal())}}
                                                    </span>
                                            </div>
                                        </div>
                                        <div data-v-f2a183a6="" class="d-table-footer">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-summary">
                                                @if($quote->discount_apply==1)
                                                    @if($quote->getTotalDiscount())
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            ...
                                                            <div data-v-f2a183a6="" class="d-table-value">{{\App\Utility::priceFormat($settings,$quote->getTotalDiscount())}}</div>
                                                        </div>
                                                    @endif
                                                @endif
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid {{$color}}; border-bottom: 1px solid {{$color}};">
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-value">{{\App\Utility::priceFormat($settings,$quote->getSubTotal()-$quote->getTotalDiscount()+$quote->getTotalTax())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
