            ...
            <div>
                 ...
                 <div class="col-12">
                    <div class="form-group">
                        ...
                        <a href="#" onclick="sendDataToReactNativeApp('{{$account->id}}')" class="rounded-circle" >
                            @if($account->user_image == 'true')
                            
                         
                             <img src="{{env('NOBS_IMAGES')}}images/user_avatar/avatar_{{$account->id}}.jpg?lastmod=<?php echo date("m/d/Y h:i:s a", time())?>" class="rounded-circle mx-auto d-block" style="height: 150px;width:auto;border:solid 2px white"
  alt="Avatar" /> 
                            @else
                              <img src="{{env('NOBS_IMAGES')}}icons/avatar1.png" class="rounded-circle mx-auto d-block" style="width: 150px;border:solid 2px white"
  alt="Avatar" /> 
