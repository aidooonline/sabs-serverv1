              ...
              <tr>
                  <td width="23%">
                      ...
                      <div style="padding-left:5px;"> 
                          ...
                          <img style="position:relative;float:left;margin-right:10px;" class="rounded-circle" src="{{env('NOBS_IMAGES')}}images/user_avatar/avatar_{{$account->id}}.jpg?lastmod=<?php echo date("m/d/Y h:i:s a", time())?>" is_dataimage="{{$account->is_dataimage}}" profilevalue="{{$account->customer_picture}}">
                          @else
