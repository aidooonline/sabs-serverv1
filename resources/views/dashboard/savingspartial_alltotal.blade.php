 ...
 <div class="listdiv2 rounded" style="margin-top:0 !important;padding-left:0 !important;padding-right:0 !important;margin-top:10;padding-top:5px;">
   ...
   <div class="displaydivs" id="todaydiv">
      ...
      <div onclick="location.href = `{{route('dashboardadmreportsview')}}/{{\Auth::user()->created_by_user}}/{{\Auth::user()->name}}/deposit`" class="col-xl-4 col-lg-6 col-md-6 col-12">
		<div class="card bg-white pt-2 pb-2">
			<div class="card-body">
				<div class="card-block pt-2 pb-0">
					<div class="media"> 
      ...
      <div onclick="location.href = `{{route('dashboardadmreportsview')}}/{{\Auth::user()->created_by_user}}/{{\Auth::user()->name}}/withdraw`" class="col-xl-4 col-lg-6 col-md-6 col-12">
		<div class="card bg-white pt-2 pb-2">
			<div class="card-body">
				<div class="card-block pt-2 pb-0">
					<div class="media"> 
      ...
      <div onclick="location.href = `{{route('dashboardadmreportsview')}}/{{\Auth::user()->created_by_user}}/{{\Auth::user()->name}}/refund`" class="col-xl-4 col-lg-6 col-md-6 col-12">
		<div class="card bg-white pt-2 pb-2">
			<div class="card-body">
				<div class="card-block pt-2 pb-0">
					<div class="media"> 
     ...
     @if(\Auth::user()->type=='Admin' || \Auth::user()->type=='owner')
      <div onclick="location.href = `{{route('dashboardadmreportsview')}}/{{\Auth::user()->created_by_user}}/{{\Auth::user()->name}}/loandisbursed`" class="col-xl-4 col-lg-6 col-md-6 col-12">
		<div class="card bg-white pt-2 pb-2">
			<div class="card-body">
				<div class="card-block pt-2 pb-0">
					<div class="media"> 
      ...
      <div onclick="location.href = `{{route('dashboardadmreportsview')}}/{{\Auth::user()->created_by_user}}/{{\Auth::user()->name}}/loanrepayment`" class="col-xl-4 col-lg-6 col-md-6 col-12">
		<div class="card bg-white pt-2 pb-2">
			<div class="card-body">
				<div class="card-block pt-2 pb-0">
					<div class="media"> 
      ...
      <div onclick="location.href = `{{route('dashboardadmreportsview')}}/{{\Auth::user()->created_by_user}}/{{\Auth::user()->name}}/agentcommission`" class="col-xl-4 col-lg-6 col-md-6 col-12">
		<div class="card bg-white pt-2 pb-2">
			<div class="card-body">
				<div class="card-block pt-2 pb-0">
					<div class="media"> 
    ...
    @if(\Auth::user()->type=='Admin' || \Auth::user()->type=='owner')
      <div onclick="location.href = `{{route('dashboardadmreportsview')}}/{{\Auth::user()->created_by_user}}/{{\Auth::user()->name}}/systemcommission`" class="col-xl-4 col-lg-6 col-md-6 col-12">
		<div class="card bg-white pt-2 pb-2">
			<div class="card-body">
				<div class="card-block pt-2 pb-0">
					<div class="media"> 
