 ...
 <div class="listdiv2 rounded" style="margin-top:0 !important;padding-left:0 !important;padding-right:0 !important;margin-top:10;padding-top:5px;">
   ...
   <div class="card-block text-center ml-2 mr-2 pl-2 pr-2">
                        <span class="badge badge-pill badge-secondary"> Agent: {{$agentname}}</span> <span class="badge badge-pill badge-secondary"> {{$nameoftransaction}}</span>
                    </div>
				...
				<div class="card-block pt-2 pb-0">
					<div class="media">
					     ...
					     <div style="padding-left:2px;"> 
                          ...
                          @else 
                          <img style="position:relative;float:left;margin-right:10px;height:70px;width:70px;" class="rounded-circle" src="{{env('NOBS_IMAGES')}}useraccounts/profileimage.png">
                          @endif 
                         </div>
                      
						<div class="media-body white text-left">
						 <h5 style="color:#724c78;text-align:left !important;">{{$thedata->amount}}</h5> 
						<h6>{{$thedata->det_rep_name_of_transaction}}</h6> 
