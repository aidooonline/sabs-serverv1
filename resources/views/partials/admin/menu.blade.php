...
<div class="menunavbar" style="z-index:9999 !important;">
  ...
  <a href="{{env('APP_URL')}}" onclick="showhidediv('loadingdiv');"  style="width:25%;height:100%;">
      <i class="fas fa-home text-light" aria-hidden="true"></i>
  </a>
  <a href="{{env('BASE_URL')}}accounts/" onclick="showhidediv('loadingdiv');" style="width:25%;height:100%;">
