...
<div class="panel listdiv2" style="margin-top: 0px !important; padding-left: 0px !important; padding-right: 0px !important; max-height: 0;overflow: hidden;transition: max-height 0.2s ease-out;">
    ...
    <table style="vertical-align: center;text-align:center;width:99%;margin-bottom:0 !important;">
        ...
        <tbody><tr> 
         <td class="btn btn-light"><a href="javascript:movetodepositpage('` + accountnumber + `',this,);" class="btn btn-xs  rounded">
              <img src="{{env('NOBS_IMAGES')}}icons/depositicon2.png" style="height:23px;width:auto;" class="fa" aria-hidden="true">
              <br>
              <span class="smallspan">Deposit</span>
               </a></td>
               
                <td class="btn btn-light"><a href="javascript:movetowithdrawalpage('` + accountnumber + `',this,);" class="btn btn-xs  rounded">
              <img src="{{env('NOBS_IMAGES')}}icons/withdrawicon2.png" style="height:23px;width:auto;" class="fa" aria-hidden="true">
              <br>
              <span class="smallspan">Withdraw</span>
               </a></td>
               
                  <td class="btn btn-light"><a href="javascript:movetorefundpage('` + accountnumber + `',this,);" class="btn btn-xs  rounded">
              <img src="{{env('NOBS_IMAGES')}}icons/reversal2.png" style="height:23px;width:auto;" class="fa" aria-hidden="true">
               <br>
              <span class="smallspan">Reverse</span>
               </a></td>
        
        
        <td class="btn btn-light"><a href="{{env('BASE_URL')}}accounts/transactiondetails/` + accountnumber + `/" class="btn btn-xs  rounded"><i class="fa fa-eye" aria-hidden="true"></i>
         <br>
            ...
            <a href="{{env('BASE_URL')}}accounts/` + accountid + `/edit" class="btn btn-xs  rounded"><i class="fa fa-pencil" aria-hidden="true"></i> 
             <br>
