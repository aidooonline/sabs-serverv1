      ...
      <div class="card-block pt-2 pb-0">
        <div class="media">
          ...
          <div class="media-body white text-left">
            ...
            <span class="tag badge badge-pill bgpurple mt-1">Interest: <span class="textcolor1">{{$loans->interest}}</span></span> 
            <span class="tag badge badge-pill bgpurple mt-1">Duration: <span class="textcolor1">{{$loans->duration}}</span></span> 
            <span class="tag badge badge-pill bgpurple mt-1">Interest Per Anum: <span class="textcolor1">{{$loans->interest_per_anum}}</span></span> 
            <span class="tag badge badge-pill bgpurple mt-1">Processing Fee: <span class="textcolor1">{{$loans->processing_fee}}%</span></span> 
            <span class="tag badge badge-pill bgpurple mt-1">Collateral Fee: <span class="textcolor1">{{$loans->collateral_fee}}%</span></span> 
