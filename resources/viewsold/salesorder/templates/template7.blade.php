                        ...
                        <div data-v-1ad6e3b9="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-1ad6e3b9="" class="d-inner d-no-pad" style="border-top: 15px solid {{$color}}; border-bottom: 15px solid {{$color}};">
                                <div data-v-1ad6e3b9="" class="row grey-box">
                                    ...
                                    <div data-v-1ad6e3b9="" class="col-33"><h1 data-v-1ad6e3b9="" class="fancy-title mb5">{{__('SALES ORDER')}}</h1> <br data-v-1ad6e3b9=""><br data-v-1ad6e3b9="">
                                        <table data-v-1ad6e3b9="" class="summary-table">
                                            ...
                                            <tr data-v-363339a0="">
                                                ...
                                                <td data-v-363339a0="" class="text-right">{{\App\Utility::salesorderNumberFormat($settings,$salesorder->invoice)}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
                                                <td data-v-363339a0="" class="tu fwb" style="color: {{$color}};">{{__('Issue Date')}}:</td>
                                                <td data-v-363339a0="" class="text-right">{{\App\Utility::dateFormat($settings,$salesorder->issue_date)}}</td>
                                            </tr>
                                    ...
                                    <div data-v-363339a0="" class="d-table">
                                        <div data-v-363339a0="" class="d-table">
                                            ...
                                            <div class="d-table-tr" style="border-bottom:1px solid {{$color}};">
                                                ...
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6="">{{\App\Utility::priceFormat($settings,$salesorder->totalRate)}}</pre>
                                                </div>
                                                <div class="d-table-td w-6">
                                                    <pre data-v-f2a183a6="">{{\App\Utility::priceFormat($settings,$salesorder->totalTaxPrice) }}</pre>
                                                </div>
                                                @if($salesorder->discount_apply==1)
                                                    <div class="d-table-td w-3">
                                                        <pre data-v-f2a183a6="">{{\App\Utility::priceFormat($settings,$salesorder->totalDiscount)}}</pre>
                                                    </div>
                                                @else
                                                    <div class="d-table-td w-3">
                                                        <pre data-v-f2a183a6="">-</pre>
                                                ...
                                                <div class="d-table-td w-4 text-right">
                                                    <span>{{\App\Utility::priceFormat($settings,$salesorder->getSubTotal())}}
                                                    </span>
                                                </div>
                                            </div>
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    @if($salesorder->discount_apply==1)
                                                        @if($salesorder->getTotalDiscount())
                                                            <div data-v-f2a183a6="" class="d-table-summary-item">
                                                                ...
                                                                <div data-v-f2a183a6="" class="d-table-value">{{\App\Utility::priceFormat($settings,$salesorder->getTotalDiscount())}}</div>
                                                            </div>
                                                        @endif
                                                    @endif
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid {{$color}}; border-bottom: 1px solid {{$color}};">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value">{{\App\Utility::priceFormat($settings,$salesorder->getSubTotal()-$salesorder->getTotalDiscount()+$salesorder->getTotalTax())}}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
