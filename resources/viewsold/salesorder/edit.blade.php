...
@section('title')
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0 ">{{__('Sales-Orders Edit')}}   {{ '('. $salesOrder->name .')' }}</h5>
    </div>
@endsection
@section('action-btn')
    <div class="btn-group" role="group">
        @if(!empty($previous))
            <a href="{{ route('salesorder.edit',$previous) }}" class="btn btn-sm btn-primary btn-icon-only rounded-circle btn-text btn-icon action mr-2" data-toggle="tooltip" data-original-title="{{__('Previous')}}">
        ...
        @endif
        @if(!empty($next))
            <a href="{{ route('salesorder.edit',$next) }}" class="btn btn-sm btn-primary btn-icon-only rounded-circle btn-text btn-icon action" data-toggle="tooltip" data-original-title="{{__('Next')}}">
                    ...
                    <div data-href="#account_edit" class="list-group-item custom-list-group-item text-primary">
                        <div class="media">
                            ...
                            <div class="media-body ml-3">
                                ...
                                <p class="mb-0 text-sm">{{__('Edit About Your sales orders Information')}}</p>
                            </div>
                        </div>
                    </div>
                    <div data-href="#invoice" class="list-group-item custom-list-group-item">
                        <div class="media">
                            ...
                            <div class="media-body ml-3">
                                ...
                                <p class="mb-0 text-sm">{{__('Assigned invoice for this sales orders')}}</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    {!!Form::select('tax[]', $tax, explode(',',$salesOrder->tax),array('class' => 'form-control','data-toggle'=>'select','multiple')) !!}
                                    @error('tax')
                            ...
                            <div class="col-6">
                                ...
                                {!! Form::select('user', $user, $salesOrder->user_id,array('class' => 'form-control ','data-toggle'=>'select')) !!}
                                @error('user')
                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="text-right">
                                <div class="actions">
                                    <a href="#" data-size="lg" data-url="{{ route('invoice.create',['salesorder',$salesOrder->id]) }}" data-ajax-popup="true" data-title="{{__('Create New Invoice')}}" class="btn btn-sm btn-primary btn-icon-only rounded-circle">
