...
<div id="mainsearchdiv">
    <h4 class="card-title" style="margin-top:20px;">
      Agent Commission: <strong class="text-warning">{{$agentname}} </strong>
      </h4> 
      ...
      <table style="background-color:#f4e9f7 !important;margin-top:20px;"  class="table-striped table-border table-panel rounded">
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td class="mintd" style="padding:1px 1px;" id="todaytotal"><span class="text-muted">GH¢</span> {{number_format($todaytotalAGTCM, 2, '.', ',')}}</td>
                  </tr>
      
                  <tr>
                    <td class="mintd" style="padding:1px 1px;">This Week:</td>
                    <td class="mintd" style="padding:1px 1px;" id="thisweektotal"><span class="text-muted">GH¢</span> {{number_format($thisweektotalAGTCM, 2, '.', ',')}}</td>
                  </tr>
      
                  <tr>
                    <td class="mintd" style="padding:1px 1px;">This Month:</td>
                    <td class="mintd" style="padding:1px 1px;" id="thismonthtotal"><span class="text-muted">GH¢</span> {{number_format($thismonthtotalAGTCM, 2, '.', ',')}}</td>
                  </tr>
      
                  <tr>
                    <td class="mintd" style="padding:1px 1px;">This Year:</td>
                    <td class="mintd" style="padding:1px 1px;" id="thismonthtotal"><span class="text-muted">GH¢</span> {{number_format($thisyeartotalAGTCM, 2, '.', ',')}}</td>
                  </tr>
