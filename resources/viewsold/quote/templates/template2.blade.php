                                ...
                                <div data-v-37eeda86="" class="col-33">
                                    ...
                                    <table data-v-37eeda86="" class="summary-table">
                                        ...
                                        <tr data-v-363339a0="">
                                            ...
                                            <td data-v-363339a0="" class="text-right">{{\App\Utility::dateFormat($settings,$quote->issue_date)}}</td>
                                        </tr>
                                        <tr data-v-363339a0="">
                                            <td data-v-363339a0="" class="tu fwb" style="color: {{$color}};">{{__('Due Date')}}:</td>
                                            <td data-v-363339a0="" class="text-right">{{\App\Utility::dateFormat($settings,$quote->due_date)}}</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
