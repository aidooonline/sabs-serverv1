...
<div  class="row dashboardtext" style="padding-bottom:150px;padding-top:60px;">
 ...
 @include('layouts.searchwithdrawal')
...
<a href="{{route('accounts.searchwithdrawer')}}" id="accountbtnpanel_{{$account->id}}"  class="accordion card listdiv" style="background:#fff;width:99%;padding-left:0;padding-right:0;margin-left:0;margin-right:0;">
