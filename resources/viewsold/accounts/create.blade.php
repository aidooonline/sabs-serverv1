            ...
            <div>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <a href="#" onclick="sendDataToReactNativeApp()" class="form-control btn btn-info" style="position:absolute;right:14px;top:-25px;width:50px;padding-left:9px;padding-right:2px;padding-top:4px;">
                            <img src="https://free-icon-rainbow.com/i/icon_00416/icon_004160_256.png" style="width:30px;height:auto;" />
                        </a>
