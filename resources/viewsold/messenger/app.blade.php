...
@section('title')
    {{-- <div class="d-inline-block"> --}}
        {{-- <h5 class="h4 d-inline-block font-weight-400 mb-0 ">{{__('Messenger')}}</h5> --}}
    {{-- </div> --}}
@endsection
                    ...
                    <nav>
                        ...
                        <div style="display: inline-block;">
                            ...
                            @if(!empty(\Auth::user()->avatar))
                                <div class="avatar av-s header-avatar" style="margin: 0px 10px; margin-top: -5px; margin-bottom: -5px;background-image: url('{{ asset('/storage/upload/profile/'.\Auth::user()->avatar) }}');"></div>
                            @else
