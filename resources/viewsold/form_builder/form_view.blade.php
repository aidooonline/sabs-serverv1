                                        ...
                                        <div class="form-group">
                                            <div class="d-flex radio-check">
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    ...
                                                    <label class="custom-control-label form-control-label" for="lead_on">{{__('Lead')}}</label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="account_on" value="account" name="is_convert" class="custom-control-input lead_radio" >
                                                    <label class="custom-control-label form-control-label" for="account_on">{{__('Account')}}</label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="contact_on" value="contact" name="is_convert" class="custom-control-input lead_radio">
                                                    <label class="custom-control-label form-control-label" for="contact_on">{{__('Contact')}}</label>
                                                </div>
                                            </div>
                                        </div>
                                        @if($objFields && $objFields->count() > 0)
                                            @foreach($objFields as $objField)
                                                ...
                                                @elseif($objField->type == 'textarea')
                                                    <div class="form-group">
                                                        {{ Form::label('field-'.$objField->id, __($objField->name),['class'=>'form-control-label']) }}
                                                        {{ Form::textarea('field['.$objField->id.']', null, array('class' => 'form-control','required'=>'required','id'=>'field-'.$objField->id,'rows'=>'3')) }}
                                                    </div>
                                                @endif
                                            @endforeach
                                        @endif
