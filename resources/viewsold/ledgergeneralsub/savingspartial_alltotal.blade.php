...
<h5 style="width:100%;position:relative;padding-left:20px;" class="text-warning">
    {{$parentname}} > 
</h5>
 ...
 <div class="listdiv2 rounded" style="margin-top:0 !important;padding-left:0 !important;padding-right:0 !important;margin-top:10px;padding-top:5px;padding-bottom:10px;">
    ...
    <a href="" style="position:absolute;right:15px;top:30px;" href="#" class="btn btn-purple  mr-1 btn-fab btn-sm">
   ...
   @foreach($ledgergeneralsub as $ledger)
				 ...
				 <div class="media"> 
                    <div class="media-left text-left">
					 ...
					 <div class="media-body white text-left">
						 <a href="{{route('subledger.create')}}/{{$parentname}}/{{$parentid}}/{{$ledgername}}/{{$ledger->id}}" ><span class="grey darken-1" style="font-size:1.2rem">{{$ledger->name}}</span></a><br/>
                         <span class="text-secondary sm" style="float:right;font-size:12px;">{{$ledger->acname}}</span>
                        <h6 class="font-small-5 mb-0 text-purple"><span  class="text-muted ghs"></span>{{number_format($ledger->amount, 2, '.', ',')}}</h6>
					 </div>
