...
class ApiUsersController extends Controller
{
    ...
    {
        if (\Auth::user()->type == 'Admin' || \Auth::user()->type == 'owner' || \Auth::user()->type == 'Agents' || \Auth::user()->type == 'super admin') {
            ...
            if ($is_transaction_enabled) {
                ...
                if ($credittrans2) {
                    ...
                    if ($transaction->save()) {
                        ...
                        $account::where('account_number', $request->accountnumber)->where('comp_id', \Auth::user()->comp_id)->update(['balance' => $accountnumberbalance]);
            ...
            if ($is_transaction_enabled) {
                ...
                if ($credittrans2) {
                    ...
                    if ($transaction->save()) {
                        ...
                        UserAccountNumbers::where('account_number', $request->accountnumber)->where('comp_id', \Auth::user()->comp_id)->update(['balance' => $totalbalance]);
