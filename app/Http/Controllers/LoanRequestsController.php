...
class LoanRequestsController extends Controller
{
    ...
    public function index($defaultview ='adminview')
    {
        ...
        if(\Auth::user()->type == 'Admin'|| \Auth::user()->type == 'owner')
        {
           ...
           // $loanmigrated = Loanrequests::where('loan_migrated',1)->orderBy('id','DESC')->get();    
            return view('loanrequests.index', compact('loanrequests','loanrequestcounts','loanrequestsum'));
        }
        else
        {
...
//End of agent query list.
    ...
    public function create(){
        ...
        return view('loanrequestdetail.create', compact('pagetitle','loanpurpose','loantypes'));
    }
    ...
    public function edit(Loans $loan)
    {
        ...
        { 
           ...
           $pagetitle = '';
            ...
            return view('loanrequests.edit', compact('pagetitle','loan'));
        }
        else
        {
            return redirect()->back()->with('error', 'permission Denied');
